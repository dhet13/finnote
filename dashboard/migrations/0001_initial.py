    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'constraints': [models.UniqueConstraint(fields=('user_id', 'snapshot_date', 'asset_type', 'stock_ticker_symbol', 'property_info_id'), name='pk_snapshot_poly'), models.CheckConstraint(condition=models.Q(models.Q(('asset_type', 'stock'), ('property_info_id__isnull', True), ('stock_ticker_symbol__isnull', False)), models.Q(('asset_type', 'real_estate'), ('property_info_id__isnull', False), ('stock_ticker_symbol__isnull', True)), _connector='OR'), name='chk_snap_polykey')],
            },
        ),
    ]
