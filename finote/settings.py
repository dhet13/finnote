"""
Django settings for finote project.
"""
...
CSRF_TRUSTED_ORIGINS = ['https://finnote-fjf9.onrender.com']
ALLOWED_HOSTS = ['*']
...
WSGI_APPLICATION = 'finote.wsgi.application'
